...
public class App {
    ...
    static public Student[] initTui() {
        ...
        String numberOfStudentsStr= scan.nextLine();
        System.out.println("Number of students is: " +numberOfStudentsStr );
        ...
        if(numberOfStudents > 0) {
            ...
            for(int i = 0; i < numberOfStudents; i++){
                System.out.println("---- Estudiante número " + (i + 1) + " ----");
                ...
                System.out.print("Número de asignaturas matriculadas: ");
                newStudent.amountOfEnrolledSubjects = scan.nextInt();
